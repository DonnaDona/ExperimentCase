...
const resources = {
    en: {
        ...
        translation: {
            ...
            "This study will take approximately 5 minutes to complete. Please do not take breaks during the study, as this will affect the results. Do not refresh the page or close the browser tab. Make sure you do not have any active translation extensions.": "Questo studio richiederà circa 5 minuti per essere completato. Si prega di non fare pause durante lo studio, poiché questo influenzerà i risultati. Non aggiornare la pagina o chiudere la scheda del browser. Assicurati di non avere un traduttore attivo.",
            "It is highly suggested to try the demo mode first, to check whether you understand the task properly and get used to the environment.": "Si consiglia vivamente di provare prima la modalità demo, per verificare se si è capito correttamente il compito e per abituarsi all'ambiente.",
